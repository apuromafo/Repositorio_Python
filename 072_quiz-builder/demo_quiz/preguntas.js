...
// TEMA dummy1: Dummy Topic One
// TEMA dummy2: Dummy Topic Two
// TEMA dummy3: Dummy Topic Three

const questionBank = [

    // --- dummy1: Dummy Topic One ---
    {
        id: 1,
        topic: "dummy1",
        question: "Pregunta 1 del tema dummy1 -- reemplaza este texto.",
    ...
    },
    {
        id: 2,
        topic: "dummy1",
        question: "Pregunta 2 del tema dummy1 -- reemplaza este texto.",
    ...
    },
    {
        id: 3,
        topic: "dummy1",
        question: "Pregunta 3 del tema dummy1 -- reemplaza este texto.",
        options: ["Respuesta A para pregunta 3", "Respuesta B para pregunta 3", "Respuesta C para pregunta 3", "Respuesta D para pregunta 3"],
        answer: 0,
        explanation: "Reemplaza esta explicacion."
    },

    // --- dummy2: Dummy Topic Two ---
    {
        id: 4,
        topic: "dummy2",
        question: "Pregunta 1 del tema dummy2 -- reemplaza este texto.",
    ...
    },
    {
        id: 5,
        topic: "dummy2",
        question: "Pregunta 2 del tema dummy2 -- reemplaza este texto.",
    ...
    },
    {
        id: 6,
        topic: "dummy2",
        question: "Pregunta 3 del tema dummy2 -- reemplaza este texto.",
        options: ["Respuesta A para pregunta 6", "Respuesta B para pregunta 6", "Respuesta C para pregunta 6", "Respuesta D para pregunta 6"],
        answer: 0,
        explanation: "Reemplaza esta explicacion."
    },

    // --- dummy3: Dummy Topic Three ---
    {
        id: 7,
        topic: "dummy3",
        question: "Pregunta 1 del tema dummy3 -- reemplaza este texto.",
    ...
    },
    {
        id: 8,
        topic: "dummy3",
        question: "Pregunta 2 del tema dummy3 -- reemplaza este texto.",
    ...
    },
    {
        id: 9,
        topic: "dummy3",
        question: "Pregunta 3 del tema dummy3 -- reemplaza este texto.",
    ...
    },
    {
        id: 10,
        topic: "dummy3",
        question: "Pregunta 4 del tema dummy3 -- reemplaza este texto.",
        options: ["Respuesta A para pregunta 10", "Respuesta B para pregunta 10", "Respuesta C para pregunta 10", "Respuesta D para pregunta 10"],
        answer: 0,
        explanation: "Reemplaza esta explicacion."
    },
