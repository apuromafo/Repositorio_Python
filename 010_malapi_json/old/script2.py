...
def menu():
    """Muestra el menú de opciones y permite al usuario seleccionar una etapa."""
    url = 'https://malapi.io'  # Cambia esta URL si es necesario
    
    while True:
        print("\n--- MENÚ ---")
        print("1. Extraer tablas de la URL")
        print("2. Procesar tablas para extraer funciones")
        print("3. Combinar funciones por categoría")
        print("4. Guardar funciones combinadas en un archivo JSON")
        print("5. Salir")
        ...
        if opcion == '1':
            ...
            print("Funciones combinadas por categoría.")
        elif opcion == '4':
            resultado = combinar_funciones_por_categoria()
